...
def test_current_xvfb_config():
    ...
    for port in test_ports:
        ...
        session_dir = Path.home() / '.firefox-launcher' / 'test-xvfb' / f'session-{port}'
        ...
        try:
            ...
            if process.poll() is None:
                ...
                xvfb_lines = [line for line in ps_result.stdout.split('\n') 
                ...
                for line in xvfb_lines:
                    ...
                    if '-displayfd' in line:
                        print(f"      ✅ Dynamic display allocation enabled")
                    else:
                        print(f"      ⚠️ No -displayfd found")
